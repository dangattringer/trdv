...
class QuoteData(BaseModel):
    ...
    change_in_accrued_expenses_fy_h: list[float | None] | None = None
    ...
    change_in_inventories_fy_h: list[float | None] | None = None
    ...
    change_in_other_assets_fy_h: list[float | None] | None = None
    change_in_other_assets_ttm: float | None = None
    change_in_taxes_payable_fq_h: list[float | None] | None = None
    change_in_taxes_payable_fy_h: list[float | None] | None = None
